...
let lexer = moo.compile({
  verb: /\b(?:ABORT|AT|BREAK|CALCUL|CALL|CALLSUB|CASE|CLOSE|COMMAND|COMMAND|CONTINUE|CREATE|DCL|DCL|DCLFILE|DCLFRAME|DCLHUGE|DCLPRINTER|DCLPROC|DCLSESSION|DCLSQLDESCRIPTOR|DCLSQLDYNAMIC|DCLSTRUCT|DCLVIEW|DELETE|FAIL|FILE|FOR|IF|LET|LOADVAR|LOOP|NEW|NOTHING|ON|OPEN|PARMHUGE|PARM|PRINT|PRINT|PRINTHTML|PROCEED|PROTECTED|REMOTE|RETRY|RETURN|RUN|RUN|SECTION|SEGMENT|SELECT|SEND|SET|SKIP|SUBMIT|SUBRETURN|SUBSECTION|TAKE|TRANSACTION|WAIT|WHILE)\b/,
  option: /\b(?:ACCESS|ACCESS|ALIAS|APPLICATION|ARITHMETIC|ARITHMETIC|AS-PDF|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASSIGN|ASYNC|ASYNC|ASYNC|BACKWARD|BASE|BASE|BATCHJOB|CENTER|COLUMNS|COMMIT-COUNT|COMPATIBLE|COMPATIBLE|CONNECT|CONNECT|CONNECT|CONNECTION|CONTROL-Y|CONTROL-Y|COUNTRY|CURSOR|CURSOR|CURSOR|CURSOR|CURSOR|DEFAULT|DISPLAY|EDIT|EDIT|EDIT|EDIT|ENCRYPT|ENCRYPT|ENVFILE|ENVFILE|ERROR|ERROR|EXECUTE|FILES|FORM|FORM|FORM|FORM|FORM|FORM|FORMAT|HEAD|HILITE|HOST|HOST|HOST|IGNORE|IGNORE|IMAGE-LOCK|IN|INIT|INIT|INPUT|IS|IS|ITEM-AREA|ITEM-AREA|ITEM-AREA|ITERATIONS|ITERATIONS|LANGUAGE|LAUNCH|LAUNCH|LEFT|LEFT|LIKE|LIKE|LOCATION|MATCH|MATCH|MATCH|MATCH|MATCH|MODIFY|NEED|NEED|NEWDEVICE|NEXT|NEXT|OMNIDEX|OPEN-IMMEDIATE|OUT|PRINTSCREEN|RAW|RECOMPILE|REDEFINES|REPORT-SETUP|RESET|RETURN-VALUE|RIGHT|RIGHT|Run-card|SCOPE|SELECTED|SEQUENCE|SEQUENCE|SHOW|SKIP|SKIP|SQL-CURSOR|SQL-DYNAMIC|SQL-ESCAPE-CLAUSE|STATEMENT|STEP|STORE|STRUCT|STRUCT|SYNC|SYNC|SYNC|SYNC|SYNC|TAKEFILE|TEXT|TIMEOUT|TIMEOUT|TIMEOUT|TITLE|USER|USING|VAL|WAIT|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW|WINDOW)\b/,
